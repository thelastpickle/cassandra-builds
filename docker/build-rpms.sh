...
# This script is deprecated, having been migrated to be in-tree since 4.2
...
[[ $cassandra_version =~ $cassandra_regx_supported_versions ]] || { echo "Cassandra ${cassandra_version} not supported. (This script is in-tree since 4.2)"; exit 1; }
